 ...
 */
case class ThreadPoolStats(`type`: String, activeTasks: Long, completedTasks: Long, currentBlockedTasks: Long, maxPoolSize: Long, pendingTasks: Long, totalBlockedTasks: Long)
