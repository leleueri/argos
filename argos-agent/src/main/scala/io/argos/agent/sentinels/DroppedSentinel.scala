...
abstract class DroppedSentinel(val metricsProvider: ActorRef, val conf: SentinelConfiguration) extends Sentinel {
...
class DroppedRequestResponseSentinel(override val metricsProvider: ActorRef, override val conf: SentinelConfiguration) extends DroppedSentinel(metricsProvider, conf) {
...
class DroppedReadSentinel(override val metricsProvider: ActorRef, override val conf: SentinelConfiguration) extends DroppedSentinel(metricsProvider, conf) {
...
class DroppedReadRepairSentinel(override val metricsProvider: ActorRef, override val conf: SentinelConfiguration) extends DroppedSentinel(metricsProvider, conf) {
...
class DroppedRangeSliceSentinel(override val metricsProvider: ActorRef, override val conf: SentinelConfiguration) extends DroppedSentinel(metricsProvider, conf) {
...
class DroppedPageRangeSentinel(override val metricsProvider: ActorRef, override val conf: SentinelConfiguration) extends DroppedSentinel(metricsProvider, conf) {
...
class DroppedMutationSentinel(override val metricsProvider: ActorRef, override val conf: SentinelConfiguration) extends DroppedSentinel(metricsProvider, conf) {
...
class DroppedCounterSentinel(override val metricsProvider: ActorRef, override val conf: SentinelConfiguration) extends DroppedSentinel(metricsProvider, conf) {
