...
object Constants {
  ...
  val CONF_OBJECT_ENTRY_SENTINEL_STAGE_COUNTER_MUTATION = CONF_OBJECT_ENTRY_SENTINEL+"stage-counter"
  val CONF_OBJECT_ENTRY_SENTINEL_STAGE_GOSSIP = CONF_OBJECT_ENTRY_SENTINEL+"stage-gossip"
  val CONF_OBJECT_ENTRY_SENTINEL_STAGE_INTERNAL = CONF_OBJECT_ENTRY_SENTINEL+"stage-internal"
  val CONF_OBJECT_ENTRY_SENTINEL_STAGE_MEMTABLE = CONF_OBJECT_ENTRY_SENTINEL+"stage-memtable"
  val CONF_OBJECT_ENTRY_SENTINEL_STAGE_MUTATION = CONF_OBJECT_ENTRY_SENTINEL+"stage-mutation"
  val CONF_OBJECT_ENTRY_SENTINEL_STAGE_COMPACTION = CONF_OBJECT_ENTRY_SENTINEL+"stage-compaction"
  val CONF_OBJECT_ENTRY_SENTINEL_STAGE_READ = CONF_OBJECT_ENTRY_SENTINEL+"stage-read"
  val CONF_OBJECT_ENTRY_SENTINEL_STAGE_READ_REPAIR = CONF_OBJECT_ENTRY_SENTINEL+"stage-read-repair"
  val CONF_OBJECT_ENTRY_SENTINEL_STAGE_REQUEST_RESPONSE= CONF_OBJECT_ENTRY_SENTINEL+"stage-request-response"
